...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="relative overflow-hidden bg-transparent py-48 lg:py-56 min-h-[120vh] flex items-center justify-center mb-16 md:mb-24 lg:mb-32">
