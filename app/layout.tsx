...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Brand Alchemy" }],
  creator: "Brand Alchemy",
  publisher: "Brand Alchemy",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    title: "Brand Alchemy - Web Development Agency",
    description: "We create brands that people want to talk about",
    type: "website",
    locale: "en_US",
    siteName: "Brand Alchemy",
  },
  twitter: {
    card: "summary_large_image",
    title: "Brand Alchemy - Web Development Agency",
    description: "We create brands that people want to talk about",
    creator: "@brandalchemy",
  },
  robots: {
    index: true,
    follow: true,
